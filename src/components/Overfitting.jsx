...
const H = 320
const PAD = 32
// И train, и test порождены одной гладкой «истиной» (пологая арка) плюс шум.
// Обучающие точки шумят вокруг арки; высокая степень полинома проходит СКВОЗЬ них
// (ошибка на обучении мала), но между ними сильно виляет и промахивается по
// тестовым точкам, лежащим на самой арке в промежутках, — ошибка на тесте растёт.
const TRAIN = [[8, 61], [17, 51], [25, 79], [33, 65], [42, 89], [50, 70], [58, 89], [67, 65], [75, 79], [83, 51], [92, 61]]
const TEST = [[13, 57], [29, 72], [46, 80], [62, 77], [79, 65], [96, 47]]
