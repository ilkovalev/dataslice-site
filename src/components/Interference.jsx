  ...
  return (
    <div className="rounded-xl border border-black/10 bg-panel p-5">
      ...
      <div className="flex flex-wrap gap-x-4 gap-y-1 mt-1 text-sm">
        <span className="text-[#9ca3af]">● A (контроль)</span>
        <span className="text-[#2ab8eb]">● B (тест)</span>
      ...
      <div className="mt-4 text-xs uppercase tracking-wider text-cyanink/80 mb-1">Как проверить SUTVA: сравните оценку в двух дизайнах</div>
