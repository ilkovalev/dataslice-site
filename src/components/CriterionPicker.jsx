...
const MECH = {
  t: 'Механизм: берёт разницу средних и делит на стандартную ошибку — t = (x̄A − x̄B) / SE. Работает со значениями.',
  z: 'Механизм: берёт разницу долей и делит на её стандартную ошибку — z = (p̂A − p̂B) / SE. Работает с долями «да/нет».',
  u: 'Механизм: ранжирует все наблюдения вместе и сравнивает их МЕСТА (статистика U ≈ P(A>B)). Работает с рангами, а не величинами.',
}
...
export default function CriterionPicker() {
  ...
  return (
    <div className="rounded-xl border border-black/10 bg-panel p-5">
      ...
      {crit && <p className="mt-2 text-xs text-gray-500">{MECH[crit]}</p>}
